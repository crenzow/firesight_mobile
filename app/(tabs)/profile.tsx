  ...
  return (
    ...
    >
      ...
      <View style={styles.settingRight}>
        {value ? <Text style={[styles.settingValue, { color: textSec }]}>{value}</Text> : null}
        {toggle ? (
          <Switch
            value={toggled}
        ...
        {value && !toggle && (
          <Ionicons name="chevron-forward" size={16} color={textSec} style={{ marginLeft: 4 }} />
        )}
      </View>
    </TouchableOpacity>
  );
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: bg }]}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        {/* Avatar + Identity */}
        <View style={[styles.identityCard, { backgroundColor: isDark ? COLORS.navyMid : COLORS.navy }]}>
          ...
          <View style={styles.badgeRow}>
            <View style={[styles.badge, { backgroundColor: statusColor + '22', borderColor: statusColor }]}>
              ...
              <Text style={[styles.badgeText, { color: statusColor }]}>{USER.status} Resident</Text>
            </View>
            <View style={[styles.badge, { backgroundColor: 'rgba(255,255,255,0.1)', borderColor: 'rgba(255,255,255,0.25)' }]}>
              <Ionicons name="id-card-outline" size={13} color={COLORS.white} />
              <Text style={[styles.badgeText, { color: COLORS.white }]}>{USER.accountId}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={[styles.statsRow, { backgroundColor: card, borderColor }]}>
          <View style={styles.statItem}>
            <Text style={[styles.statValue, { color: COLORS.red }]}>{USER.totalReports}</Text>
        ...
        <View style={[styles.card, { backgroundColor: card, borderColor }]}>
          <Text style={[styles.cardTitle, { color: textPrimary }]}>Account Information</Text>
          <SettingRow
            icon="person-outline"
            label="Full Name"
            value={USER.name}
        ...
        {/* Notifications */}
        <View style={[styles.card, { backgroundColor: card, borderColor }]}>
          <Text style={[styles.cardTitle, { color: textPrimary }]}>Notifications</Text>
          <SettingRow
...
/>
          ...
          {PAST_REPORTS.map((r, i) => (
            <View
              ...
              style={[
                styles.reportRow,
                {
                  borderBottomColor: i < PAST_REPORTS.length - 1 ? borderColor : 'transparent',
                },
              ]}
            >
              <View
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.reportLocation, { color: textSec }]}>{r.location}</Text>
              ...
              >
                <Text
                  style={[
                    styles.statusText,
                    { color: r.status === 'Resolved' ? COLORS.green : COLORS.textMuted },
                  ]}
                >
                  {r.status}
                </Text>
        ...
        {/* Logout */}
        <TouchableOpacity style={[styles.logoutBtn, { borderColor: COLORS.red }]}>
